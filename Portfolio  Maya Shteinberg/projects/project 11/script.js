...
// פונקציה שרצה בהפעלת האתר ובודקת האם המשתמש מחובר
...
function setUser(user = null) {
    ...
    if (user) {
        ...
        divUser.querySelector('.userName').innerHTML = `שלום ${user.fullName}`;
        getProducts();
    } else {
